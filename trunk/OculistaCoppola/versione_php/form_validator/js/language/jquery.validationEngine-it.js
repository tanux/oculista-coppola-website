    ...
    newLang: function(){
      $.validationEngineLanguage.allRules = {
        "required": { // Add your regex rules here, you can take telephone as an example
          ...
          "alertTextCheckbox": "* E' richiesta la selezione della casella"
        },
        "length": {
          "regex": "none",
          "alertText": "* Fra ",
        ...
        "phone": {
         ...
         "italian_phone": {
          "regex": /[0-9\?]{9,10}/,
          "alertText": "* Rispettare il formato del recapito telefonico come mostrato"
        },
        "email": {
        ...
        "onlyLetterSp": {
          "regex": /^[a-zA-Z\ \']+$/,
          "alertText": "* Caratteri permessi:lettere e apice"
        },
        "validate2fields": {
